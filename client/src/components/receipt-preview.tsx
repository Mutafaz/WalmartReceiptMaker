          ...
          <div id="receipt-preview" className="receipt-paper p-4 mx-auto max-w-md border border-gray-200 font-receipt text-sm leading-tight text-black font-semibold">
            ...
            <div className="border-t border-dotted border-black pt-2 mb-3">
              ...
              {paymentInfo.method !== "CASH" && (
                <div className="text-xs pt-1">
                  <div className="flex justify-between">
                    <div>APPROVAL # {paymentInfo.approvalCode}</div>
                    <div>CHANGE DUE: {paymentInfo.change}</div>
                  </div>
                  <div>CARD # **** **** **** {paymentInfo.cardLastFour}</div>
                  <div>REF #: {paymentInfo.referenceNumber}</div>
                  <div>NETWORK ID: {paymentInfo.networkId}</div>
                  <div>AID: {paymentInfo.aid}</div>
                  <div>ARC: {paymentInfo.arc}</div>
                </div>
              )}
            ...
            <div className="mt-4 text-center">
              ...
              <div className="text-[10px] leading-tight my-2 text-black">
                ...
                <div className="mt-1">www.survey.walmart.com</div>
                <div>Survey Code: {storeInfo.surveyCode}</div>
              </div>
